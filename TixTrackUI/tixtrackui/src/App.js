            ...
            <div id="carouselExampleFade" className="carousel slide" data-ride="carousel">
              <div className="carousel-inner" >
                <div className="carousel-item active">
                  <img src= {carouselImg1} className="d-block w-100 img-fluid" alt="images"/>
                </div>
                <div className="carousel-item">
                  <img src={carouselImg2} className="d-block w-100 img-fluid" alt="images"/>
                </div>
                <div className="carousel-item">
                  <img src={carouselImg3} className="d-block w-100 img-fluid" alt="images"/>
                </div>
                <div className="carousel-item">
                  <img src={carouselImg4} className="d-block w-100 img-fluid" alt="images"/>
                </div>
              </div>
